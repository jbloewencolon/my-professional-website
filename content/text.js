(function () {
  ...
  const pages = {
    ...
    speaking: {
      ...
      lead: "One practice, four ways in: an advisory retainer for the group governing AI over time, a scoped project for the single hard question, a workshop for the team about to ship, and a talk for the room that needs to think differently. Advisory is the core of the practice; a keynote is often how it starts.",
      workingTogetherHeading: "What working together looks like",
      talksHeading: "The talks",
      talksLead: "Not paper abstracts — these are talks a booker can actually put on a program, workshopped on stages from Berlin to Toronto and calibrated for rooms that contain both engineers and the people who pay them.",
